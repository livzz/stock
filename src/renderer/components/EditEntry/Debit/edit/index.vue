                  ...
                  <div class="level-item">
                    ...
                    <div class="level-item">
                        <div>
                            ...
                            <input class="input" placeholder="Number" v-model="debitno">
                        </div>
                    </div>
                    <div class="level-item">
                        <div>
                            <div>
                                ...
                                <input class="input" placeholder="invoice" v-model="invoiceNumber">
                            </div>
                        </div>
                    </div>
                    <div class="level-item">
                        <div>
                            <div>
                                ...
                                <input class="input" placeholder="invoice" v-model="originaldate">
                            </div>
                        </div>
                    </div>
                    <div class="level-item">
                        <div>
                            <div>
                                ...
                                <input class="input" placeholder="date" v-model="date" type="date" readonly>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  methods: {
    ...
    updateEvent(){
      ...
      if (this.checkFields()) {
        ...
        console.log(x);
        this.db.debit_note.update({_id:this._id},x, err => {
          if (err) {
            alert("Error Try Again!!", "Stock Manager");
          } else {
            this.rows = [];
...
//  }
  ...
  created() {
    ...
    this.db.debit_note = new Datastore({ filename: "debit_note", autoload: true });
  },
  watch: {
   y:function(){
  ...
  mounted() {
     ...
     this.$electron.ipcRenderer.on('message', (event, data) => {
        console.log(data);
        this._id = data.trim();
        this.db.debit_note.find({_id:data}, (err, docs) => {
        if (err) {
          ...
          //  this.selectedParty = this.findParty(d.detail.party.gstin);
            ...
            this.invoiceNumber = d.detail.invoiceno;
            this.y=d.detail.party;
            this.debitno=d.detail.debit_number;
            this.originaldate=d.detail.original_date;
