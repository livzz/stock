                  ...
                  <div class="level-item">
                    ...
                    <div class="level-item">
                        <div>
                            ...
                            <input class="input" placeholder="Number" v-model="creditno">
                        </div>
                    </div>
                    <div class="level-item">
                        <div>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      //  console.log(x);
        this.db.credit_note.insert(x, err => {
          if (err) {
    ...
    updateEvent(){
      ...
      if (this.checkFields()) {
        ...
        console.log(x);
        this.db.credit_note.update({_id:this._id},x, err => {
          if (err) {
            alert("Error Try Again!!", "Stock Manager");
          } else {
            this.rows = [];
...
//  }
  ...
  mounted() {
     ...
     this.$electron.ipcRenderer.on('message', (event, data) => {
        console.log(data);
        this._id = data.trim();
        this.db.credit_note.find({_id:data}, (err, docs) => {
        if (err) {
          ...
          //  this.selectedParty = this.findParty(d.detail.party.gstin);
            ...
            this.creditno=d.detail.credit_number;
            this.originaldate=d.detail.originalDate;
