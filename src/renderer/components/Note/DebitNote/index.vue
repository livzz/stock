...
<div class="section">
  <div class="column is-primary">
    ...
    <div class="container-fluid partyDetailDiv">
        ...
        <app-add-purchase-list ref="addSalesList" :party="selectedParty" :data="{ date,debitNumber:debitNumber, selectedParty,originalInvoiceNumber:originalInvoiceNumber,originalDate:originalDate }"></app-add-purchase-list>
