...
<div class="section">
  <div class="column is-primary">
    ...
    <div class="container-fluid partyDetailDiv">
        ...
        <app-add-purchase-list ref="addSalesList" :new="localParty" :data="{ date,creditNumber:creditNumber, selectedParty,originalInvoiceNumber:originalInvoiceNumber,originalDate:originalDate }"></app-add-purchase-list>
